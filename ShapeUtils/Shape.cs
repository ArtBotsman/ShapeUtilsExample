...
namespace ShapeUtils
{
    ...
    public abstract class Shape
    {
        ...
        public virtual double GetSquare()
        {
            ...
            // В задании было не ясно нужно ли делать вычисление площади для неизвестной фигуры
            // в смысле кода или в реальном смысле
            // Поэтому появился этот бызовый класс в котором предпологается базовое решение проблемы
            // Любой наследник может пользоваться этим решением
